...
* 📊 Em data_analysis_portfolio você encontra o meu portfólio de projetos em análise de dados. Aqui, eu faço uso do Python e do Power BI para realizar tratamento, análise de dados e visualização de dados.
